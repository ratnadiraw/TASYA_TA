...
(function ($) {
  ...
  dt = {
    ...
    process: function process(skipPushState) {
  ...
  processAll = function processAll(skipPushState) {
    var data = {};
  ...
  function Sorts(obj, settings) {
    ...
    this.guessType = function (a, b, attr) {
      var types = {
        ...
        object: 'number' // dates and null values are also objects, this works...
          ...
          attrType = a[attr] ? _typeof(a[attr]) : _typeof(b[attr]),
    ...
    this.functions = {
      number: function number(a, b, attr, direction) {
        return a[attr] === b[attr] ? 0 : direction > 0 ? a[attr] - b[attr] : b[attr] - a[attr];
      },
      string: function string(a, b, attr, direction) {
      ...
      originalPlacement: function originalPlacement(a, b) {
  ...
  function Queries(obj, settings) {
    ...
    this.setupInputs = function () {
      settings.inputs.queries.each(function () {
        var $this = $(this),
            ...
            queryFunction = function queryFunction(e) {
          var q = $(this).val();
          if (q === "") {
            q = undefined;
          }
    ...
    this.functions = {
      search: function search(record, queryValue) {
        var contains = false;
  ...
  utility = dt.utility = {
    normalizeText: function normalizeText(text, style) {
      text = this.textTransform[style](text);
      return text;
    },
    textTransform: {
      trimDash: function trimDash(text) {
      ...
      dashed: function dashed(text) {
        text = this.trimDash(text);
        return this.lowercase(text);
      },
      underscore: function underscore(text) {
        text = this.trimDash(text);
    ...
    refreshQueryString: function refreshQueryString(urlString, data, settings) {
      var _this = this,
    ...
    keysFromObject: function keysFromObject(obj) {
      var keys = [];
      for (var key in obj) {
        keys.push(key);
      }
    ...
    findObjectInArray: function findObjectInArray(array, objectAttr) {
      var _this = this,
          foundObject;
    ...
    allMatch: function allMatch(item, arrayOrObject, test) {
    ...
    anyMatch: function anyMatch(item, arrayOrObject, test) {
      var match = false,
          isArray = $.isArray(arrayOrObject);
    ...
    randomHash: function randomHash() {
