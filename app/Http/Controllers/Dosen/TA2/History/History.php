...
namespace App\Http\Controllers\Dosen\TA2\History;
...
class History extends Controller
{
	...
	public function index()
	{
		...
		$all_progress_summary = DB::table('ta2_dosen_ta')
		...
		return view('dosen.ta2.history.history', [
	...
	public function show($ps_id)
	{
		...
		return view('dosen.ta2.history.show_progress_summary', [
			'dosens' => $dosens,
