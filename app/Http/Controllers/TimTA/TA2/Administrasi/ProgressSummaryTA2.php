...
class ProgressSummaryTA2 extends Controller
{
    ...
    public function index()
    {
      ...
      return view('tim_ta.ta2.administrasi.daftar_progress_summary', $data);
    }
    ...
    public function getAll() {
        ...
        return view('tim_ta.ta2.administrasi.daftar_progress_summary', [
    ...
    public function editProgressSummary($ps_id) {
        ...
        if ($data_summary == null) {
            return redirect('tim_ta/ta2/administrasi/daftar_progress_summary');
        }
        ...
        $lulus = false;
        $ta2 = TA2_TA::find($data_summary->ta_id);
        if ($ta2->status_lulus == 1) {
            $lulus = true;
        }
        ...
        $all_kelas_mahasiswa = DB::table('ta2_mahasiswa_kelas')
         ...
         return view('tim_ta.ta2.administrasi.edit_progress_summary', [
             'dosens' => $dosens,
