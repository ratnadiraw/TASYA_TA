...
class BeritaAcara extends Controller
{
    ...
    public function index() {
        ...
        return view('tim_ta.ta2.seminar.lampiran_berita_acara_seminar', $data);
    }

    public function viewBeritaAcaraIndividual($seminar_id) {
        ...
        return view('tim_ta.ta2.seminar.berita_acara_seminar_individual', [
    ...
    public function viewBeritaAcara($seminar_id) {
        ...
        return view('tim_ta.ta2.seminar.view_lampiran_berita_acara_seminar', [
            'berita_acara' => $berita_acara,
            'data_summary' => $data_summary,
            'seminar' => $seminar,
        ]);
    ...
    public function editBeritaAcara($seminar_id) {
        ...
        return view('tim_ta.ta2.seminar.add_lampiran_berita_acara_seminar', [
            'berita_acara' => $berita_acara,
            'data_summary' => $data_summary,
            'seminar' => $seminar,
        ]);
