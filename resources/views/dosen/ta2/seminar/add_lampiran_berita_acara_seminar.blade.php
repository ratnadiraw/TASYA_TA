        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="berita-acara">
                    <form action="/dosen/ta2/seminar/add_lampiran_berita_acara_seminar_submit" method="POST">
                        ...
                        <div class="berita-acara-content">
                            ...
                            <div class="row berita-acara-content-data justify-content-center">
                                <button type="submit" class="btn btn-primary btn-margin" name="lulus" value="1">Lulus</button>
                                <button type="Submit" class="btn btn-secondary btn-margin" name="lulus" value="0">Tidak Lulus</button>
                            </div>
                        </div>
                    </form>
                </div>
