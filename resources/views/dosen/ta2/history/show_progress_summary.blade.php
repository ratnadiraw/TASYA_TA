...
@section('title')
    <title>Progress Summary Mahasiswa | Dosen</title>
@endsection
@section('content')
    <div class="container">
        <div class="row">
            ...
            @if($lulus_seminar)
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><b><a href="/dosen/ta2/seminar/view_berita_acara/{{$seminar_done->seminar_id}}">View berita acara seminar</a></b></td>
                    </tr>
                </table>
                ...
                @if($lulus_sidang)
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><b><a href="/dosen/ta2/sidang/view_berita_acara_individual/{{$sidang_lulus->sidang_id}}">View nilai akhir</a></b></td>
                        </tr>
                    </table>
