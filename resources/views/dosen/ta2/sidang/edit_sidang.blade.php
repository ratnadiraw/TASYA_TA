    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="card col-md-8 edit-mom">
                <div class="card-header"><h3>Edit Jadwal dan Ruangan Penguji</h3></div>
                <div class="card-body overflow-visible">
                    <form action="/dosen/ta2/sidang/edit_sidang_submit" enctype="multipart/form-data" method="POST" class="">
                        ...
                        <div class="add-bimbingan-content">
                            <table>
                                ...
                                @foreach($dosen_penguji as $no =>$dosen)
                                <tr>
                                    <td>
                                        <div class="add-bimbingan-content-field font-weight-bold">
                                            Penguji {{$no + 1}}:
