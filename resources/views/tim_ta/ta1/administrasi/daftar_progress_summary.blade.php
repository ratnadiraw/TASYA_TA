...
@section('content')
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @if (count($summarys) > 0)
                    <table class="table table-striped" id="progress-summmary-TimTA-table">
                        <thead>
                        <tr>
                            <th> No </th>
                            <th> NIM </th>
                        ...
                        @foreach($summarys as $summary)
                            <tr>
                                ...
                                <td>{{$summary->nama}}</td>
                                <td>
                                    <form action="/tim_ta/ta1/administrasi/edit_progress_summary/{{$summary->id}}" method="get">
...
@section('scripts')
    <script>
        $(document).ready(function()
            {
                $("#progress-summmary-TimTA-table").dynatable();
            }
        );
        $.when($("#progress-summmary-TimTA-table").dynatable()).done(function() {
