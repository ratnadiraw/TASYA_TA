...
@section('title')
    <title>View Berita Acara Sidang | Mahasiswa</title>
@endsection
@section('content')
    <div class="container">
        @if ($errors->any())
                ...
                <div class="berita-acara">
                    <div class="berita-acara-content">
                        ...
                        <div class="row berita-acara-content-data">
                            ...
                            <div class="col-md-9 col-xs-9">
                                @if ($berita_acara->berita_acara != null)
                                    <a href="/mahasiswa/ta2/download_berita_acara/{{$berita_acara->bas_id}}"> View berita acara sidang </a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row berita-acara-content-data">
                            ...
                            <div class="col-md-9 col-xs-9">
                                @if ($berita_acara->lembar_finalisasi != null)
                                    <a href="/mahasiswa/ta2/download_lembar_finalisas   i/{{$berita_acara->bas_id}}"> View lembar finalisasi </a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row berita-acara-content-data">
                            ...
                            @else
                                <div class="col-md-9 col-xs-9"> Belum dinyatakan lulus</div>
                            @endif
                        </div>
                    </div>
                </div>
