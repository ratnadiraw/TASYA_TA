...
@section('title')
    <title>Berita Acara Seminar | Mahasiswa</title>
@endsection
@section('content')
    <div class="container">
        @if ($errors->any())
        ...
        <div class="card">
            ...
            <div class="berita-acara-content">
                ...
                <div class="row berita-acara-content-data">
                    ...
                    <div class="col-md-9 col-xs-9"><a href="/mahasiswa/ta2/download_berita_acara_seminar/{{$berita_acara->berita_acara_id}}"> View document</a></div>
                </div>
