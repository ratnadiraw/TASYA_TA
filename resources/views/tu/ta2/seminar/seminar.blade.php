...
@section('content')
    <div class="container">
        ...
        @if (count($listOfSeminar) > 0)
            {{--<form action="/tu/ta2/seminar/edit_seminar_submit" method="POST">--}}
                ...
                <table class="table table-striped">
                    ...
                    @foreach ($listOfSeminar as $seminar)
                        <tr>
                            ...
                            <td>{{$seminar->judul}}</td>
                            <td>
                                <form action="/tu/ta2/progress_summary/edit_progress_summary/{{$seminar->ps_id}}" method="get">
