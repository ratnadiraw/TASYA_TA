...
@section('title')
    <title>Lampiran Berita Acara Seminar | TU</title>
@endsection
@section('content')
    <div class="container">
        @if ($errors->any())
            ...
            <div class="card-header">
                ...
                <div class="berita-acara-content">
                    ...
                    <div class="row berita-acara-content-data">
                        ...
                        <div class="col-md-9 col-xs-9"><a href="/tu/ta2/seminar/download_berita_acara/{{$berita_acara->berita_acara_id}}"> View document</a></div>
                    </div>
