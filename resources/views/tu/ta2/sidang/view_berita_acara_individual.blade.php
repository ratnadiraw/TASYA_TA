                ...
                <div class="berita-acara">
                    <div class="berita-acara-content">
                        ...
                        <div class="row berita-acara-content-data">
                            ...
                            <div class="col-md-9 col-xs-9">
                                @if ($berita_acara->berita_acara != null)
                                    <a href="/tu/ta2/sidang/download_berita_acara/{{$berita_acara->bas_id}}"> View berita acara sidang </a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row berita-acara-content-data">
                            ...
                            <div class="col-md-9 col-xs-9">
                                @if ($berita_acara->lembar_finalisasi != null)
                                    <a href="/tu/ta2/sidang/download_lembar_finalisasi/{{$berita_acara->bas_id}}"> View lembar finalisasi </a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row berita-acara-content-data">
                            ...
                            @else
                                <div class="col-md-9 col-xs-9"><span style="color:green"> Dinyatakan belum lulus ✕ </span></div>
                            @endif
                        </div>
                    </div>
                </div>
